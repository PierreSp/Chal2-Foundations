...
// /////////////////////////////////////////////////////////////
// LIMIT IS DEFINED HERE(removed for test sending)7
...
//We now multiply our dataset 18 times to get all the neighbour buckets (because there might be interessting points in neighbour buckets as well)
